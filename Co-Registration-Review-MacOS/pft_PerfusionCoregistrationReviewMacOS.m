function varargout = pft_PerfusionCoregistrationReviewMacOS(varargin)
% PFT_PERFUSIONCOREGISTRATIONREVIEWMACOS MATLAB code for pft_PerfusionCoregistrationReviewMacOS.fig
%      PFT_PERFUSIONCOREGISTRATIONREVIEWMACOS, by itself, creates a new PFT_PERFUSIONCOREGISTRATIONREVIEWMACOS or raises the existing
%      singleton*.
%
%      H = PFT_PERFUSIONCOREGISTRATIONREVIEWMACOS returns the handle to a new PFT_PERFUSIONCOREGISTRATIONREVIEWMACOS or the handle to
%      the existing singleton*.
%
%      PFT_PERFUSIONCOREGISTRATIONREVIEWMACOS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PFT_PERFUSIONCOREGISTRATIONREVIEWMACOS.M with the given input arguments.
%
%      PFT_PERFUSIONCOREGISTRATIONREVIEWMACOS('Property','Value',...) creates a new PFT_PERFUSIONCOREGISTRATIONREVIEWMACOS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before pft_PerfusionCoregistrationReviewMacOS_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to pft_PerfusionCoregistrationReviewMacOS_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help pft_PerfusionCoregistrationReviewMacOS

% Last Modified by GUIDE v2.5 24-Apr-2020 16:10:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @pft_PerfusionCoregistrationReviewMacOS_OpeningFcn, ...
                   'gui_OutputFcn',  @pft_PerfusionCoregistrationReviewMacOS_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function pft_PerfusionCoregistrationReviewMacOS_OpeningFcn(hObject, eventdata, handles, varargin)

% Choose default command line output for pft_PerfusionCoregistrationReviewMacOS
...
% UIWAIT makes pft_PerfusionCoregistrationReviewMacOS wait for user response (see UIRESUME)
% uiwait(handles.MainFigure);
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function varargout = pft_PerfusionCoregistrationReviewMacOS_OutputFcn(hObject, eventdata, handles) 
...
function MainFigure_SizeChangedFcn(hObject, eventdata, handles)
  % Nothing to do here - the function exists because the dialog is resizable
end
