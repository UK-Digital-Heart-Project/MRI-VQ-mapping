function pft_MultiModalCoregisterOnePickleFileAutomatically(SourceFileName, LUF)
...
SourcePicklePath = fullfile(TopLevelFolder, SourceFileName);
...
p = strfind(SourceFileName, '.');
q = p(end);
r = q - 1;

TargetFileName = sprintf('%s-MM-Spline-Coregistered.mat', SourceFileName(1:r));

TargetPicklePath = fullfile(TopLevelFolder, TargetFileName);
