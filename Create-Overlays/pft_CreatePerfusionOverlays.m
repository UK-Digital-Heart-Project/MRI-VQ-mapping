function varargout = pft_CreatePerfusionOverlays(varargin)

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @pft_CreatePerfusionOverlays_OpeningFcn, ...
                   'gui_OutputFcn',  @pft_CreatePerfusionOverlays_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function pft_CreatePerfusionOverlays_OpeningFcn(hObject, eventdata, handles, varargin)

% Choose default command line output for pft_CreatePerfusionOverlays
...
% UIWAIT makes pft_CreatePerfusionOverlays wait for user response (see UIRESUME)
...
function varargout = pft_CreatePerfusionOverlays_OutputFcn(hObject, eventdata, handles) 
