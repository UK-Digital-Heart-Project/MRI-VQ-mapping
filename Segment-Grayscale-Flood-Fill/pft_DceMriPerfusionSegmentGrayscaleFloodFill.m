function varargout = pft_DceMriPerfusionSegmentGrayscaleFloodFill(varargin)

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @pft_DceMriPerfusionSegmentGrayscaleFloodFill_OpeningFcn, ...
                   'gui_OutputFcn',  @pft_DceMriPerfusionSegmentGrayscaleFloodFill_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function pft_DceMriPerfusionSegmentGrayscaleFloodFill_OpeningFcn(hObject, eventdata, handles, varargin)

% Choose default command line output for pft_DceMriPerfusionSegmentGrayscaleFloodFill
...
% UIWAIT makes pft_DceMriPerfusionSegmentGrayscaleFloodFill wait for user response (see UIRESUME)
...
function varargout = pft_DceMriPerfusionSegmentGrayscaleFloodFill_OutputFcn(hObject, eventdata, handles) 
