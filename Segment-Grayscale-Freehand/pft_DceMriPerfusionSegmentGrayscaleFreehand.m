function varargout = pft_DceMriPerfusionSegmentGrayscaleFreehand(varargin)

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @pft_DceMriPerfusionSegmentGrayscaleFreehand_OpeningFcn, ...
                   'gui_OutputFcn',  @pft_DceMriPerfusionSegmentGrayscaleFreehand_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function pft_DceMriPerfusionSegmentGrayscaleFreehand_OpeningFcn(hObject, eventdata, handles, varargin)

% Choose default command line output for pft_DceMriPerfusionSegmentGrayscaleFreehand
...
% UIWAIT makes pft_DceMriPerfusionSegmentGrayscaleFreehand wait for user response (see UIRESUME)
...
function varargout = pft_DceMriPerfusionSegmentGrayscaleFreehand_OutputFcn(hObject, eventdata, handles) 
