...
Listing = dir(fullfile(Root, 'HH*HYBRID*QUANTIFICATION*.xlsx'));
...
Target = fullfile(Root, 'HYBRID-QUANTIFICATION-COMPILATION.xlsx');
Backup = fullfile(Root, 'HYBRID-QUANTIFICATION-COMPILATION-BACKUP.xlsx');
...
for n = 1:NFILES
  ...
  pft_AppendOneXlsxHybridQuantificationFile(Source, Target);
